Codes performed a time series analysis for each (Europe) OECD country from to 2000 to 2019
- Independent variable: year
- Dependent variable: natural log of RGDP per capita of a country

Codes stored the time series analysis in a dictionary, and provide a regression interpretation for the country selected.
